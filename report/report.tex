...
\begin{figure}[t]
\begin{center}
   \subfloat{\includegraphics[width=1\linewidth]{dragon-image.eps}}
   \quad
   \subfloat{\includegraphics[width=1\linewidth]{dragon-shape.eps}}
\end{center}
...
\begin{figure*}
\begin{center}
	\includegraphics[scale=0.45]{dragon-grid.eps}
\end{center}
